 ...
 * @return   {void} 
 */
// ConnectMiddleware.prototype.processRoute = function (req, res, next) {
...
//   this.apiCore.intercom.emit( emitEvent, emitValue );
 ...
 * @return   {void} 
 */
ConnectMiddleware.prototype.routeVerbGET = function (req, res, next) {

  var emitValue = null,
    uniqueRouteKey = req.method + '::' + req.route.path,
    emitEvent = this.apiCore._routeEventTracker[uniqueRouteKey];
 ...
 * @return   {void} 
 */
ConnectMiddleware.prototype.routeVerbPOST = function (req, res, next) {
  var emitValue = null,
    uniqueRouteKey = req.method + '::' + req.route.path,
    emitEvent = this.apiCore._routeEventTracker[uniqueRouteKey];
 ...
 * @return   {void} 
 */
ConnectMiddleware.prototype.routeVerbPUT = function (req, res, next) {
 ...
 * @return   {void} 
 */
ConnectMiddleware.prototype.routeVerbDELETE = function (req, res, next) {
...
ConnectMiddleware.prototype.getRequestVariables = function(req, res, next) {
  ...
  if( req.method == 'GET' || req.method == 'PUT' ){
    ...
    if( req.hasOwnProperty('body') && req.body !== undefined ){
