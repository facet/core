...
ConnectMiddleware.prototype.routeVerbGET = function(apiCore) {
  ...
  return function (req, res, next) {
    ...
    console.log(emitValue, uniqueRouteKey, emitEvent);
...
ConnectMiddleware.prototype.getRequestVariables = function(req, res, next) {
  ...
  // console.log("req method in getRequestVariables: ", req.method);
  ...
  if( req.method == 'GET' || req.method == 'PUT' ){
    ...
    // console.log("req params in getRequestVariables: ", req["params"]);
    // console.log("apiModelId: ", apiModelId);
    ...
    // console.log("req body in getRequestVariables: ", req.body);
