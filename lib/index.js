...
FacetCore.prototype.setupRouterManifest = function () {
  this.routerManifest = {
    apiEventType: 'facet-core',
    apiModelId: 'coreFacetId', // this is the id for this module 
    routeBase: '/facet-core',  // this can be overwritten
    routes: [
    ],
    routeErrorMessages: {
 ...
 * @return   {void}
 */
FacetCore.prototype.find = function( query, successCb, errorCb ){
 ...
 */
FacetCore.prototype.makeCheckAccessCb = function (queryBuilder, returnPromise, successCb, errorCb) {
  var _this = this;
  ...
  var checkAccessCb = function checkAccessCb(allow){
    ...
    if(allow === true) {
      ...
      var result = _this.respond('facet:response:' + _this.routerManifest.apiEventType + ':data', promise, 'No products matched your criteria.', successCb, errorCb);
 ...
 * @return   {void}
 */
FacetCore.prototype.findOne = function(query, successCb, errorCb) {
  var _this = this;
  ...
  var accessSuccessCb = function(result){
    console.log('why am I in here twice?');
    var promise = queryBuilder.exec();
 ...
 * @return   {void}
 */
FacetCore.prototype.update = function(query, successCb, errorCb) {
  var _this = this;
  if( typeof query === undefined || query === null || !query.hasOwnProperty('conditions') ) {
    this.intercom.emit('facet:response:error', 400, this.routerManifest.routeErrorMessages.conditions);
    return Promise.reject(this.routerManifest.routeErrorMessages.conditions);
 ...
 * @return   {void}
 */
FacetCore.prototype.create = function(data, successCb, errorCb) {
  var _this = this;
 ...
 * @return   {void}
 */
FacetCore.prototype.remove = function(conditions, successCb, errorCb) {
  var _this = this;
 ...
 * @return   {void}
 */
FacetCore.prototype.preAPIRoute = function(req, res, next) {
  this._req = req;
  this._res = res;
  this._next = next;
 ...
 * @return   {void}
 */
FacetCore.prototype.getRequestVariables = function(req, res, next) {
  var emitValue = null,
 ...
 * @return   {void} 
 */
FacetCore.prototype.processRoute = function (req, res, next) {
 ...
 * @return   {void} 
 */
FacetCore.prototype.routeVerbGET = function (req, res, next) {
 ...
 * @return   {void} 
 */
FacetCore.prototype.routeVerbPOST = function (req, res, next) {
 ...
 * @return   {void} 
 */
FacetCore.prototype.routeVerbPUT = function (req, res, next) {
 ...
 * @return   {void} 
 */
FacetCore.prototype.routeVerbDELETE = function (req, res, next) {
