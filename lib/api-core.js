...
FacetApiCore.prototype.registerApiCoreEvents = function() {  
  this.intercom.on('facet:request:processor', this.requestToQuery.bind(this));
};
...
FacetApiCore.prototype.requestToQuery = function( req, crudEvent ){

  console.log("in FacetApiCore::requestToQuery ", req, crudEvent);
  console.log("");
  console.log("");
