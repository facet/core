...
var FacetApiCore = function( options ) {
  ...
  console.log('just instantiated FacetApiCore');
};
...
FacetApiCore.prototype.bindRouterManifest = function() {
  ...
  for (var i = 0, j = routes.length; i < j; i++) {
    ...
    // console.log('uniqueRouteKey: ', uniqueRouteKey);
    // console.log('');
