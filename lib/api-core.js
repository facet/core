...
FacetApiCore.prototype.find = function( query, successCb, errorCb ){
  ...
  // TODO: clean fields (ex. tenant_id, +password, +api_key, +<sensitive_fields>)
...
FacetApiCore.prototype.create = function(data, successCb, errorCb) {
  ...
  if( !_.isUndefined(this._req.apiUser.tenant_id) ) {
    data['tenant_id'] = this._req.apiUser.tenant_id;
  }
