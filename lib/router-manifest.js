 ...
 * @return  {Object}               The Router Manifest Object
 */
RouterManifest.prototype.addRoutes = function(routes){
  this.manifest.routes = this.manifest.routes.concat(routes);
...
RouterManifest.prototype.extendRouteErrorMessages = function(routeErrorMessages){
  ...
  newRouteErrorMessages = _.extend({}, this.manifest.routeErrorMessages);

  // if route error messages is passed in, extend the new route error messages
  if( typeof routeErrorMessages !== 'undefined' ){
    newRouteErrorMessages = _.extend(newRouteErrorMessages, routeErrorMessages);
  }
